...
/// Magic first byte in handler response payload that signals to IpcReceiver
/// that this connection should be marked as approved.
pub const APPROVE_CONNECTION: u8 = 0x01;
